...
export default function Home() {
  ...
  return (
    <div className="game-content animate__animated animate__fadeInUpBig">
        <h4 className="">How-to-Naraka</h4>
        <p>This chapter explains how to participate in NARAKA games and earn GM rewards!</p>
        ...
        <div className="game-text">
            ...
            <span>  using the command “setnaraka your_name your server”,set your NARAKA character name and the server you are on. </span>
        </div> 
        <div className="game-text">
            <strong>Step 5:</strong>
            <span>  Complete a game with the specified game character according to the bot's reply to complete the character binding.</span>
