    ...
    <main className="flex flex-col items-center justify-between p-1" >
      ...
      <div className="welcome">
        <div className="welcome-left">
          ...
          <p className="welcome-content font-Montserrat">We've put together a guide so you can easily know how to get involved in GoodmorningNetwork's GameMining!</p>
      ...
      <div className="welcome">
        ...
        <div className="welcome-left" style={{width:'75%'}}>
          ...
          <p className="welcome-content font-Montserrat" >We've put together a guide so you can easily know how to get involved in GoodmorningNetwork's PowMining!</p>
          <div className="game-list">
            <div className="game-list-item">
              <a src="" ></a>
              <span className="game-list-item-icon"></span>
